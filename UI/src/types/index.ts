...
export type RequestStatus = "pending" | "in_progress" | "completed" | "denied" | "analyzing" | "approved";
export type RequestType = "service" | "coverage";
export type ServiceType = "plumber" | "electrician" | "mason" | "locksmith" | "painter" | "carpenter" | "cleaner" | "other";
export type CoverageType = "theft" | "flood" | "structural_damage" | "fire" | "other";
...
export interface Plan {
  ...
  name: string;
  price: number;
  servicesPerMonth: number; // -1 = unlimited
